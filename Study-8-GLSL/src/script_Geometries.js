...
const material01 = new THREE.MeshStandardMaterial({color: 0x11FFFF});
...
const material02 = new THREE.MeshStandardMaterial({color: 0x0853FF1});
...
const material03 = new THREE.MeshLambertMaterial({color: 0x904F98});
...
const material05 = new THREE.MeshNormalMaterial({wireframe: true});
...
// Object10 지오메트리 + 머터리얼 생성
const geometry10 = new THREE.SphereGeometry(10,32,16);
const material10 = new THREE.MeshLambertMaterial({color: 0x2255ff, wireframe: true});
const object10 = new THREE.Mesh(geometry10, material10);
object10.position.set(0, 0, 0);
scene.add(object10);
